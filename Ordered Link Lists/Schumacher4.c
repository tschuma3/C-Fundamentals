...
int main(int argc, char *argv[]) 
{
	...
	// Welcomes user to the program and asks for the user's input
...
void insertNode(struct listNode * newNode)
{
	...
	// As long as current is not null and newNode is greater than current, insert the new node
...
void freeTheList()
{
	...
	// Does the while loop as long as long as current isn't null
	while (current != NULL)
	{
